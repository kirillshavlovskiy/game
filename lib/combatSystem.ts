...
const BONUS_REWARDS: MonsterBonusReward[] = [
  ...
  { type: "storedArtifact", kind: "dragonFuryAxe", amount: 1 },
  { type: "storedArtifact", kind: "eternalFrostblade", amount: 1 },
  { type: "storedArtifact", kind: "zweihandhammer", amount: 1 },
  { type: "storedArtifact", kind: "azureDragonShield", amount: 1 },
